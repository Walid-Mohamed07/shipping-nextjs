...
export async function POST(request: NextRequest) {
  try {
    ...
    if (!Array.isArray(finalAvailableDays) || (finalAvailableDays.length < 2 && !finalAvailableDays.includes("All Week"))) {
    ...
    broadcastToAdmins("REQUEST_CREATED", normalizedRequest, newRequest._id.toString());
