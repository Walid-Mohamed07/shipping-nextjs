  ...
  useEffect(() => {
    ...
    if (user && user.id) {
      const fetchOrders = async () => {
        try {
          const response = await fetch(`/api/driver/orders?driverId=${user.id}`)
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-medium text-foreground">{order.request.from}</p>
                        </div>
                      </div>
                      <div className="flex gap-2">
                        <MapPin className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                        <div className="flex-1">
                          ...
                          <p className="font-medium text-foreground">{order.request.to}</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-medium text-foreground">{order.request.item}</p>
                        </div>
                      </div>
                      <div className="flex gap-2">
                        <Package className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                        <div className="flex-1">
                          ...
                          <p className="font-medium text-foreground">{order.request.category}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      <div className="flex gap-2 items-start">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-medium text-foreground text-sm">{order.vehicle.name}</p>
